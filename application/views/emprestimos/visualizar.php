...
<h1 class="ls-title">
                        ...
                        switch ($status) {
   case 1:
         echo '<a href="<?php echo base_url() ?>emprestimos/aprovar/<?php echo $id ?>" class="ls-btn-primary ls-btn-sm ls-ico-plus">Aceitar</a>';
...
<div class="col-md-8">
    ...
    <p><strong>Local de uso do material</strong></p>
      ...
      <p class="ls-break-text"> O nome do material deve aparecer aqui
