...
ALTER TABLE `notificacao`
  ADD CONSTRAINT `fk_usuario_notificacao` FOREIGN KEY (`id_usuario`) REFERENCES `usuario` (`id`),
  ADD CONSTRAINT `fk_contato_notificacao` FOREIGN KEY (`id_contato`) REFERENCES `contatos` (`id`);
