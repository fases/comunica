...
<div class="container-fluid">
    ...
    <a href="<?= ROOT ?>usuarios/add" class="ls-btn-primary" aria-expanded="false">Cadastrar novo</a>
    ...
    <table class="ls-table">
        ...
        <tbody>
            ...
            <tr>
                <td>
                    <a href="<?=ROOT?>usuarios/visualizar.php">João da Silva</a>
                ...
                <td class="ls-txt-right ls-regroup">
                    <a href="<?=ROOT?>usuarios/visualizar.php" class="ls-btn ls-btn-sm" aria-expanded="false">Visualizar</a>
