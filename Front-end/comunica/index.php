...
<html class="ls-theme-gray">
    <head>
        ...
        <link href="locaweb/stylesheets/locastyle.css" rel="stylesheet" type="text/css" />
    </head>
...
<!--                            <img title="Logo login" src="../../../assets/images/locastyle/logo-locaweb.jpg" />-->
                        ...
                        <form role="form" class="ls-form ls-login-form" action="home.php">
                            <fieldset>
                                ...
                                <p class="ls-txt-center ls-login-signup">
                                    Não possui um usuário no Comuinca? <a href="#">Cadastre-se agora</a>
                                </p>
        ...
        <script src="locaweb/javascripts/libs/jquery-2.1.0.min.js" type="text/javascript"></script>
        <script src="locaweb/javascripts/locastyle.js" type="text/javascript"></script>
